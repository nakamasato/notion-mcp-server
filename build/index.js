...
async function makeNotionRequest(path, method, body) {
...
server.tool("notion_retrieve_page", "Retrieves a Notion page by its ID", {
...
server.tool("notion_search", "Searches for pages in Notion", {
...
server.tool("notion_create_page", "Creates a new page in Notion", {
...
server.tool("notion_update_page", "Updates a page in Notion", {
